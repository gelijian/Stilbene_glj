...
PrimaryGeneratorMessenger::PrimaryGeneratorMessenger(PrimaryGeneratorAction* Gun):Action(Gun)
{
	...
	ParticleNameCmd = new G4UIcmdWithAString("/Source/Gun/ParticleName",this);
	...
	SourceTypeCmd = new G4UIcmdWithAString("/Source/Gun/SourceType", this);
	SourceTypeCmd->SetGuidance("Set Type of source energy");
	SourceTypeCmd->SetGuidance("SourceType : mono(default), flat, Cf252, expdecay, gauss, rect, Tubulate");
	SourceTypeCmd->SetParameterName("SourceType",true);
	SourceTypeCmd->SetDefaultValue("mono");
	SourceTypeCmd->SetCandidates("mono flat Cf252 expdecay gauss rect Tubulate");
	SourceTypeCmd->AvailableForStates(G4State_PreInit, G4State_Idle);

	SourceEnergyCmd = new G4UIcmdWithADoubleAndUnit("/Source/Gun/SourceEnergy",this);
	...
	SEconst = new G4UIcmdWithADoubleAndUnit("/Source/Gun/SEconst",this);
	...
	SourceRadiusCmd = new G4UIcmdWithADoubleAndUnit("/Source/Gun/SourceRadius",this);
	...
	SourcePosition_zCmd = new G4UIcmdWithADoubleAndUnit("/Source/Gun/SourcePosition_z",this);
	...
	MomentumThetaRangeCmd = new G4UIcmdWithADoubleAndUnit("/Source/Gun/MomentumThetaRange", this);
